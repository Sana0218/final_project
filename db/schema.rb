...
ActiveRecord::Schema[7.1].define(version: 2026_08_23_003045) do
  ...
  create_table "diaries", force: :cascade do |t|
    ...
    t.text "feedback"
    t.jsonb "suggested_phrases", default: [], null: false
  ...
  create_table "user_phrases", force: :cascade do |t|
    ...
    t.boolean "review_completed", default: false, null: false
